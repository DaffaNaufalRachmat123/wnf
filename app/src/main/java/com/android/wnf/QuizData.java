...
public class QuizData {
    ...
    private void initializeQuizList(){
        parentQuizList.add(new ParentQuiz(0 , "Quiz 1" , new ArrayList<Quiz>() {{
            add(new Quiz(0 , "\\textbf{Hasil dari}\\frac{1}{4}+\\frac{1}{5} \\textbf{adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
            ...
            add(new Quiz(1 , "\\textbf{Hasil dari} 17 - (3 x (-8)) \\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
                add(new Answer(4 , "49" , 0 , 0, -1 , 1));
                add(new Answer(5 , "41" , 0 , 1, -1 , 1));
                add(new Answer(6 , "-7" , 0 , 0, -1 , 1));
                add(new Answer(7 , "-41" , 0 , 0, -1 , 1));
            }}, 0 , 0 ,0 , 0));
            add(new Quiz(2 , "\\textbf{Hasil dari}-14 + 19\\textbf{adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
            ...
            add(new Quiz(3 , "\\textbf{Hasil dari} 4\\frac{1}{2}+3\\frac{2}{5}\\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} 0,125 + 0,25 \\textbf{adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
        ...
        parentQuizList.add(new ParentQuiz(1 , "Quiz 2" , new ArrayList<Quiz>(){{
            add(new Quiz(4 , "\\textbf{Hasil dari} \\sqrt[3]{729} \\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} -18 - (-18) \\textbf{adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} \\frac{3}{4}x\\frac{1}{5} \\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} Bentuk Desimal dari \\frac{7}{5} \\textbf{adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} \\quad 1\\frac{2}{5}÷\\frac{14}{5} \\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
        ...
        parentQuizList.add(new ParentQuiz(2 , "Quiz 3" , new ArrayList<Quiz>(){{
            ...
            add(new Quiz(4 , "\\textbf{Pecahan Biasa dari 27% adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari 4,5÷1,5 adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
                add(new Answer(48 , "0,3" , 0 , 0, -1 , 1));
                add(new Answer(49 , "3" , 0 , 1, -1 , 1));
                add(new Answer(50 , "30" , 0 , 0, -1 , 1));
                add(new Answer(51 , "300" , 0 , 0, -1 , 1));
            }}, 0 , 0 ,0 , 0));
            add(new Quiz(4 , "\\textbf{Jika Kamu Mempunyai Bilangan [2,3,5,7,11].}\\\textbf{Bilangan yang kamu punya adalah ...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} 1\\frac{2}{5}÷\\frac{1}{5} \\textbf{adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
        ...
        parentQuizList.add(new ParentQuiz(3 , "Quiz 4" , new ArrayList<Quiz>(){{
            add(new Quiz(4 , "\\textbf{Bentuk Pecahan}\\Campuran dari \\frac{12}{8} \\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari}5^{2} \\textbf{adalah...}" , R.raw.happy_girly , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} 3\\frac{3}{4}-2\\frac{1}{5} \\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Apa yang dimaksud dengan}\\5^{3}" , R.raw.happy_girly , new ArrayList<Answer>() {{
            ...
            add(new Quiz(4 , "\\textbf{Budi Punya angka} \\frac{4}{5}.\\ \textbf{Angka 5} \\textbf{adalah...}" , R.raw.solo_guitar , new ArrayList<Answer>() {{
