    ...
    private void initializeQuizList(){
        parentQuizList.add(new ParentQuiz(0 , "Quiz 1" , new ArrayList<Quiz>() {{
            ...
            add(new Quiz(2 , "\\textbf{Hasil dari}-14 + 19\\textbf{adalah...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(8 , "Bilangan Nol" , 0 , 0, -1 , 1));
                add(new Answer(9 , "Bilangan Bulat Positif" , 0 , 1, -1 , 1));
                add(new Answer(10 , "Bilangan Bulat Negatif" , 0 , 0, -1 , 1));
                add(new Answer(11, "Bilangan Pecahan" , 0 , 0, -1 , 1));
            }}, 0 ,0 , 0));
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} 0,125 + 0,25 \\textbf{adalah...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(16 , "0,15" , 0 , 0, -1 , 1));
                add(new Answer(17 , "0,75" , 0 , 0, -1 , 1));
                add(new Answer(18 , "0,315" , 0 , 0, -1 , 1));
                add(new Answer(19 , "0,375" , 0 , 1, -1 , 1));
            }}, 0 ,0 , 0));
        }}));
        parentQuizList.add(new ParentQuiz(1 , "Quiz 2" , new ArrayList<Quiz>(){{
            add(new Quiz(4 , "\\textbf{Hasil dari} \\sqrt[3]{729} \\textbf{adalah...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(20 , "3" , 0 , 0, -1 , 1));
                add(new Answer(21 , "7" , 0 , 0, -1 , 1));
                add(new Answer(22 , "11" , 0 , 0, -1 , 1));
                add(new Answer(23 , "9" , 0 , 1, -1 , 1));
            }}, 0 ,0 , 0));
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari} Bentuk Desimal dari \\frac{7}{5} \\textbf{adalah...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(32 , "0,12" , 0 , 0, -1 , 1));
                add(new Answer(33 , "1,2" , 0 , 0, -1 , 1));
                add(new Answer(34 , "1,4" , 0 , 1, -1 , 1));
                add(new Answer(35 , "0,14" , 0 , 0, -1 , 1));
            }}, 0 ,0 , 0));
        ...
        parentQuizList.add(new ParentQuiz(2 , "Quiz 3" , new ArrayList<Quiz>(){{
            add(new Quiz(4 , "\\textbf{Manakah yang disebut Bilangan Genap...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(40 , "1,3,5,7,..." , 0 , 0, -1 , 1));
                add(new Answer(41 , "1,2,3,4,5,..." , 0 , 0, -1 , 1));
                add(new Answer(42 , "2,4,6,7,8,..." , 0 , 0, -1 , 1));
                add(new Answer(43 , "2,4,6,8,10,..." , 0 , 1, -1 , 1));
            }}, 0 ,0 , 0));
            ...
            add(new Quiz(4 , "\\textbf{Jika Kamu Mempunyai Bilangan [2,3,5,7,11].}\\\textbf{Bilangan yang kamu punya adalah ...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(52 , "Bilangan Prima" , 0 , 1, -1 , 1));
                add(new Answer(53 , "Bilangan Bulat Negatif" , 0 , 0, -1 , 1));
                add(new Answer(54 , "Bilangan Ganjil" , 0 , 0, -1 , 1));
                add(new Answer(55 , "Bilangan Genap" , 0 , 0, -1 , 1));
            }}, 0 ,0 , 0));
        ...
        parentQuizList.add(new ParentQuiz(3 , "Quiz 4" , new ArrayList<Quiz>(){{
            ...
            add(new Quiz(4 , "\\textbf{Hasil dari}5^{2} \\textbf{adalah...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(64 , "22" , 0 , 0, -1 , 1));
                add(new Answer(65 , "23" , 0 , 0, -1 , 1));
                add(new Answer(66 , "24" , 0 , 0, -1 , 1));
                add(new Answer(67 , "25" , 0 , 1, -1 , 1));
            }}, 0 ,0 , 0));
            ...
            add(new Quiz(4 , "\\textbf{Apa yang dimaksud dengan}\\5^{3}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(72 , "5+5+5" , 0 , 0, -1 , 1));
                add(new Answer(73 , "5 x 3" , 0 , 0, -1 , 1));
                add(new Answer(74 , "5x5x5" , 0 , 1, -1 , 1));
                add(new Answer(75 , "3x3x3x3x3" , 0 , 0, -1 , 1));
            }}, 0 ,0 , 0));
            add(new Quiz(4 , "\\textbf{Budi Punya angka} \\frac{4}{5}.\\Angka 5 \\textbf{adalah...}" , R.raw.boruto_opening , new ArrayList<Answer>() {{
                add(new Answer(76 , "Perkalian" , 0 , 0, -1 , 1));
                add(new Answer(77 , "Pembagian" , 0 , 0, -1 , 1));
                add(new Answer(78 , "Pembilang" , 0 , 0, -1 , 1));
                add(new Answer(79 , "Penyebut" , 0 , 1, -1 , 1));
            }}, 0 ,0 , 0));
        }}));
